    ...
    _.forEach(api, function (op, m) {
      ...
      _.forEach(params, function (parameter) {
        ...
        if (parameter.in === 'body') {
          ...
          method.methodParams.push(parameter.camelCaseName)
      ...
      method.isHaveQuery = method.parameters.some(x=>x["in"]=="query")
      method.isHaveBody = method.parameters.some(x=>x["in"]=="body")
      method.isHaveFormData = method.parameters.some(x=>x["in"]=="formData")
      if(method.isHaveQuery){
        method.methodParams.push("queryParams")
      }  
      if(method.isHaveBody || method.isHaveFormData){
        method.methodParams.push("bodyParams")
      }  
      method.methodParamsStr=method.methodParams.join(",")
